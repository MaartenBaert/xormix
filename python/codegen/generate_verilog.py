...
def generate_tb(n, filename):
	...
	with open(filename, 'w') as f:
		...
		f.write(f'        reset <= 1\'b1;\n')
		f.write(f'        enable <= 1\'b0;\n')
		f.write(f'        @(posedge clk);\n')
		f.write(f'        reset <= 1\'b0;\n')
		f.write(f'        enable <= 1\'b1;\n')
		f.write(f'        for (i = 0; i < results; i = i + 1) begin\n')
		f.write(f'            @(posedge clk);\n')
		f.write(f'            if (result !== ref_result[{n} * streams * i +: {n} * streams])\n')
		f.write(f'                $display("Incorrect result");\n')
		f.write(f'        end\n')
		f.write(f'        run <= 0;\n')
		f.write(f'    end\n')
		f.write(f'    \n')
