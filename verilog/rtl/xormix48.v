...
module xormix48
    ...
    always @(posedge clk) begin
        if (rst == 1'b1) begin
            ...
            r_state_x[ 0] <= r_state_x[22] ^ r_state_x[15] ^ r_state_x[43] ^ r_state_x[ 7] ^ r_state_x[11];
            r_state_x[ 1] <= r_state_x[42] ^ r_state_x[14] ^ r_state_x[12] ^ r_state_x[35] ^ r_state_x[11] ^ r_state_x[17];
            r_state_x[ 2] <= r_state_x[15] ^ r_state_x[31] ^ r_state_x[24] ^ r_state_x[44] ^ r_state_x[47];
            r_state_x[ 3] <= r_state_x[26] ^ r_state_x[32] ^ r_state_x[47] ^ r_state_x[21] ^ r_state_x[35] ^ r_state_x[11];
            r_state_x[ 4] <= r_state_x[ 6] ^ r_state_x[46] ^ r_state_x[36] ^ r_state_x[ 4] ^ r_state_x[33];
            r_state_x[ 5] <= r_state_x[33] ^ r_state_x[19] ^ r_state_x[24] ^ r_state_x[32] ^ r_state_x[ 3] ^ r_state_x[38];
            r_state_x[ 6] <= r_state_x[ 1] ^ r_state_x[38] ^ r_state_x[47] ^ r_state_x[16] ^ r_state_x[21];
            r_state_x[ 7] <= r_state_x[25] ^ r_state_x[28] ^ r_state_x[29] ^ r_state_x[24] ^ r_state_x[35] ^ r_state_x[43];
            r_state_x[ 8] <= r_state_x[34] ^ r_state_x[ 5] ^ r_state_x[41] ^ r_state_x[ 3] ^ r_state_x[ 0];
            r_state_x[ 9] <= r_state_x[37] ^ r_state_x[34] ^ r_state_x[22] ^ r_state_x[ 2] ^ r_state_x[13] ^ r_state_x[14];
            r_state_x[10] <= r_state_x[45] ^ r_state_x[ 1] ^ r_state_x[40] ^ r_state_x[ 8] ^ r_state_x[17];
            r_state_x[11] <= r_state_x[20] ^ r_state_x[41] ^ r_state_x[ 9] ^ r_state_x[23] ^ r_state_x[32] ^ r_state_x[24];
            r_state_x[12] <= r_state_x[ 4] ^ r_state_x[23] ^ r_state_x[25] ^ r_state_x[ 5] ^ r_state_x[35];
            r_state_x[13] <= r_state_x[ 8] ^ r_state_x[19] ^ r_state_x[14] ^ r_state_x[28] ^ r_state_x[44] ^ r_state_x[26];
            r_state_x[14] <= r_state_x[ 3] ^ r_state_x[10] ^ r_state_x[35] ^ r_state_x[46] ^ r_state_x[12];
            r_state_x[15] <= r_state_x[15] ^ r_state_x[ 2] ^ r_state_x[35] ^ r_state_x[31] ^ r_state_x[43] ^ r_state_x[29];
            r_state_x[16] <= r_state_x[ 6] ^ r_state_x[ 5] ^ r_state_x[11] ^ r_state_x[ 8] ^ r_state_x[20];
            r_state_x[17] <= r_state_x[28] ^ r_state_x[10] ^ r_state_x[37] ^ r_state_x[24] ^ r_state_x[35] ^ r_state_x[ 5];
            r_state_x[18] <= r_state_x[31] ^ r_state_x[42] ^ r_state_x[17] ^ r_state_x[45] ^ r_state_x[21];
            r_state_x[19] <= r_state_x[42] ^ r_state_x[45] ^ r_state_x[36] ^ r_state_x[ 9] ^ r_state_x[31] ^ r_state_x[28];
            r_state_x[20] <= r_state_x[27] ^ r_state_x[39] ^ r_state_x[19] ^ r_state_x[ 0] ^ r_state_x[38];
            r_state_x[21] <= r_state_x[14] ^ r_state_x[40] ^ r_state_x[16] ^ r_state_x[ 9] ^ r_state_x[25] ^ r_state_x[18];
            r_state_x[22] <= r_state_x[20] ^ r_state_x[27] ^ r_state_x[ 2] ^ r_state_x[45] ^ r_state_x[42];
            r_state_x[23] <= r_state_x[44] ^ r_state_x[40] ^ r_state_x[20] ^ r_state_x[ 3] ^ r_state_x[25] ^ r_state_x[ 7];
            r_state_x[24] <= r_state_x[16] ^ r_state_x[22] ^ r_state_x[39] ^ r_state_x[ 8] ^ r_state_x[13];
            r_state_x[25] <= r_state_x[ 4] ^ r_state_x[46] ^ r_state_x[38] ^ r_state_x[33] ^ r_state_x[40] ^ r_state_x[26];
            r_state_x[26] <= r_state_x[13] ^ r_state_x[ 6] ^ r_state_x[47] ^ r_state_x[ 2] ^ r_state_x[ 7];
            r_state_x[27] <= r_state_x[27] ^ r_state_x[28] ^ r_state_x[10] ^ r_state_x[32] ^ r_state_x[ 0] ^ r_state_x[12];
            r_state_x[28] <= r_state_x[36] ^ r_state_x[ 3] ^ r_state_x[26] ^ r_state_x[39] ^ r_state_x[30];
            r_state_x[29] <= r_state_x[39] ^ r_state_x[12] ^ r_state_x[21] ^ r_state_x[38] ^ r_state_x[46] ^ r_state_x[30];
            r_state_x[30] <= r_state_x[ 9] ^ r_state_x[41] ^ r_state_x[27] ^ r_state_x[12] ^ r_state_x[18];
            r_state_x[31] <= r_state_x[45] ^ r_state_x[12] ^ r_state_x[47] ^ r_state_x[ 1] ^ r_state_x[ 3] ^ r_state_x[23];
            r_state_x[32] <= r_state_x[24] ^ r_state_x[25] ^ r_state_x[29] ^ r_state_x[20] ^ r_state_x[18];
            r_state_x[33] <= r_state_x[31] ^ r_state_x[ 2] ^ r_state_x[45] ^ r_state_x[11] ^ r_state_x[25] ^ r_state_x[30];
            r_state_x[34] <= r_state_x[17] ^ r_state_x[ 7] ^ r_state_x[10] ^ r_state_x[34] ^ r_state_x[44];
            r_state_x[35] <= r_state_x[ 4] ^ r_state_x[27] ^ r_state_x[ 0] ^ r_state_x[41] ^ r_state_x[43] ^ r_state_x[17];
            r_state_x[36] <= r_state_x[ 5] ^ r_state_x[17] ^ r_state_x[46] ^ r_state_x[44] ^ r_state_x[39];
            r_state_x[37] <= r_state_x[ 4] ^ r_state_x[42] ^ r_state_x[ 0] ^ r_state_x[ 6] ^ r_state_x[23] ^ r_state_x[22];
            r_state_x[38] <= r_state_x[40] ^ r_state_x[43] ^ r_state_x[ 7] ^ r_state_x[ 6] ^ r_state_x[29];
            r_state_x[39] <= r_state_x[23] ^ r_state_x[29] ^ r_state_x[43] ^ r_state_x[32] ^ r_state_x[36] ^ r_state_x[14];
            r_state_x[40] <= r_state_x[ 0] ^ r_state_x[13] ^ r_state_x[15] ^ r_state_x[16] ^ r_state_x[25];
            r_state_x[41] <= r_state_x[19] ^ r_state_x[30] ^ r_state_x[16] ^ r_state_x[ 6] ^ r_state_x[36] ^ r_state_x[44];
            r_state_x[42] <= r_state_x[37] ^ r_state_x[ 4] ^ r_state_x[23] ^ r_state_x[41] ^ r_state_x[13];
            r_state_x[43] <= r_state_x[33] ^ r_state_x[22] ^ r_state_x[19] ^ r_state_x[41] ^ r_state_x[28] ^ r_state_x[37];
            r_state_x[44] <= r_state_x[24] ^ r_state_x[34] ^ r_state_x[ 5] ^ r_state_x[ 1] ^ r_state_x[ 9];
            r_state_x[45] <= r_state_x[27] ^ r_state_x[37] ^ r_state_x[33] ^ r_state_x[32] ^ r_state_x[ 7] ^ r_state_x[47];
            r_state_x[46] <= r_state_x[41] ^ r_state_x[10] ^ r_state_x[15] ^ r_state_x[ 8] ^ r_state_x[42];
            r_state_x[47] <= r_state_x[ 8] ^ r_state_x[18] ^ r_state_x[19] ^ r_state_x[ 3] ^ r_state_x[10] ^ r_state_x[37];
