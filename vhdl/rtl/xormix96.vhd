        ...
        if rising_edge(clk) then
            if reset = '1' then
                ...
                for i in 0 to streams - 1 loop
                    ...
                    v_res( 0) := v_mixup( 0) xor (v_mixup(42) and not v_mixup(46)) xor v_mixup(35) xor v_mixup(43) xor v_mixin((i + 50) mod 96);
                    v_res( 1) := v_mixup( 1) xor (v_mixup(43) and not v_mixup(47)) xor v_mixup(36) xor v_mixup(44) xor v_mixin((i + 20) mod 96);
                    v_res( 2) := v_mixup( 2) xor (v_mixup(44) and not v_mixup(48)) xor v_mixup(37) xor v_mixup(45) xor v_mixin((i + 91) mod 96);
                    v_res( 3) := v_mixup( 3) xor (v_mixup(45) and not v_mixup(49)) xor v_mixup(38) xor v_mixup(46) xor v_mixin((i + 59) mod 96);
                    v_res( 4) := v_mixup( 4) xor (v_mixup(46) and not v_mixup(50)) xor v_mixup(39) xor v_mixup(47) xor v_mixin((i + 26) mod 96);
                    v_res( 5) := v_mixup( 5) xor (v_mixup(47) and not v_mixup(51)) xor v_mixup(40) xor v_mixup(48) xor v_mixin((i +  4) mod 96);
                    v_res( 6) := v_mixup( 6) xor (v_mixup(48) and not v_mixup(52)) xor v_mixup(41) xor v_mixup(49) xor v_mixin((i + 58) mod 96);
                    v_res( 7) := v_mixup( 7) xor (v_mixup(49) and not v_mixup(53)) xor v_mixup(42) xor v_mixup(50) xor v_mixin((i + 25) mod 96);
                    v_res( 8) := v_mixup( 8) xor (v_mixup(50) and not v_mixup(54)) xor v_mixup(43) xor v_mixup(51) xor v_mixin((i + 71) mod 96);
                    v_res( 9) := v_mixup( 9) xor (v_mixup(51) and not v_mixup(55)) xor v_mixup(44) xor v_mixup(52) xor v_mixin((i + 77) mod 96);
                    v_res(10) := v_mixup(10) xor (v_mixup(52) and not v_mixup(56)) xor v_mixup(45) xor v_mixup(53) xor v_mixin((i + 13) mod 96);
                    v_res(11) := v_mixup(11) xor (v_mixup(53) and not v_mixup(57)) xor v_mixup(46) xor v_mixup(54) xor v_mixin((i +  2) mod 96);
                    v_res(12) := v_mixup(12) xor (v_mixup(54) and not v_mixup(58)) xor v_mixup(47) xor v_mixup(55) xor v_mixin((i + 30) mod 96);
                    v_res(13) := v_mixup(13) xor (v_mixup(55) and not v_mixup(59)) xor v_mixup(48) xor v_mixup(56) xor v_mixin((i + 72) mod 96);
                    v_res(14) := v_mixup(14) xor (v_mixup(56) and not v_mixup(60)) xor v_mixup(49) xor v_mixup(57) xor v_mixin((i + 11) mod 96);
                    v_res(15) := v_mixup(15) xor (v_mixup(57) and not v_mixup(61)) xor v_mixup(50) xor v_mixup(58) xor v_mixin((i + 15) mod 96);
                    v_res(16) := v_mixup(16) xor (v_mixup(58) and not v_mixup(62)) xor v_mixup(51) xor v_mixup(59) xor v_mixin((i + 45) mod 96);
                    v_res(17) := v_mixup(17) xor (v_mixup(59) and not v_mixup(63)) xor v_mixup(52) xor v_mixup(60) xor v_mixin((i + 61) mod 96);
                    v_res(18) := v_mixup(18) xor (v_mixup(60) and not v_mixup(64)) xor v_mixup(53) xor v_mixup(61) xor v_mixin((i + 80) mod 96);
                    v_res(19) := v_mixup(19) xor (v_mixup(61) and not v_mixup(65)) xor v_mixup(54) xor v_mixup(62) xor v_mixin((i + 19) mod 96);
                    v_res(20) := v_mixup(20) xor (v_mixup(62) and not v_mixup(66)) xor v_mixup(55) xor v_mixup(63) xor v_mixin((i + 33) mod 96);
                    v_res(21) := v_mixup(21) xor (v_mixup(63) and not v_mixup(67)) xor v_mixup(56) xor v_mixup(64) xor v_mixin((i + 35) mod 96);
                    v_res(22) := v_mixup(22) xor (v_mixup(64) and not v_mixup(68)) xor v_mixup(57) xor v_mixup(65) xor v_mixin((i + 62) mod 96);
                    v_res(23) := v_mixup(23) xor (v_mixup(65) and not v_mixup(69)) xor v_mixup(58) xor v_mixup(66) xor v_mixin((i +  1) mod 96);
                    v_res(24) := v_mixup(24) xor (v_mixup(66) and not v_mixup(70)) xor v_mixup(59) xor v_mixup(67) xor v_mixin((i + 74) mod 96);
                    v_res(25) := v_mixup(25) xor (v_mixup(67) and not v_mixup(71)) xor v_mixup(60) xor v_mixup(68) xor v_mixin((i + 18) mod 96);
                    v_res(26) := v_mixup(26) xor (v_mixup(68) and not v_mixup(72)) xor v_mixup(61) xor v_mixup(69) xor v_mixin((i + 90) mod 96);
                    v_res(27) := v_mixup(27) xor (v_mixup(69) and not v_mixup(73)) xor v_mixup(62) xor v_mixup(70) xor v_mixin((i + 66) mod 96);
                    v_res(28) := v_mixup(28) xor (v_mixup(70) and not v_mixup(74)) xor v_mixup(63) xor v_mixup(71) xor v_mixin((i + 67) mod 96);
                    v_res(29) := v_mixup(29) xor (v_mixup(71) and not v_mixup(75)) xor v_mixup(64) xor v_mixup(72) xor v_mixin((i + 88) mod 96);
                    v_res(30) := v_mixup(30) xor (v_mixup(72) and not v_mixup(76)) xor v_mixup(65) xor v_mixup(73) xor v_mixin((i + 28) mod 96);
                    v_res(31) := v_mixup(31) xor (v_mixup(73) and not v_mixup(77)) xor v_mixup(66) xor v_mixup(74) xor v_mixin((i + 53) mod 96);
                    v_res(32) := v_mixup(32) xor (v_mixup(74) and not v_mixup(78)) xor v_mixup(67) xor v_mixup(75) xor v_mixin((i + 23) mod 96);
                    v_res(33) := v_mixup(33) xor (v_mixup(75) and not v_mixup(79)) xor v_mixup(68) xor v_mixup(76) xor v_mixin((i + 94) mod 96);
                    v_res(34) := v_mixup(34) xor (v_mixup(76) and not v_mixup(80)) xor v_mixup(69) xor v_mixup(77) xor v_mixin((i + 55) mod 96);
                    v_res(35) := v_mixup(35) xor (v_mixup(77) and not v_mixup(81)) xor v_mixup(70) xor v_mixup(78) xor v_mixin((i + 37) mod 96);
                    v_res(36) := v_mixup(36) xor (v_mixup(78) and not v_mixup(82)) xor v_mixup(71) xor v_mixup(79) xor v_mixin((i + 34) mod 96);
                    v_res(37) := v_mixup(37) xor (v_mixup(79) and not v_mixup(83)) xor v_mixup(72) xor v_mixup(80) xor v_mixin((i + 24) mod 96);
                    v_res(38) := v_mixup(38) xor (v_mixup(80) and not v_mixup(84)) xor v_mixup(73) xor v_mixup(81) xor v_mixin((i + 65) mod 96);
                    v_res(39) := v_mixup(39) xor (v_mixup(81) and not v_mixup(85)) xor v_mixup(74) xor v_mixup(82) xor v_mixin((i + 46) mod 96);
                    v_res(40) := v_mixup(40) xor (v_mixup(82) and not v_mixup(86)) xor v_mixup(75) xor v_mixup(83) xor v_mixin((i + 32) mod 96);
                    v_res(41) := v_mixup(41) xor (v_mixup(83) and not v_mixup(87)) xor v_mixup(76) xor v_mixup(84) xor v_mixin((i + 84) mod 96);
                    v_res(42) := v_mixup(42) xor (v_mixup(84) and not v_mixup(88)) xor v_mixup(77) xor v_mixup(85) xor v_mixin((i + 79) mod 96);
                    v_res(43) := v_mixup(43) xor (v_mixup(85) and not v_mixup(89)) xor v_mixup(78) xor v_mixup(86) xor v_mixin((i + 48) mod 96);
                    v_res(44) := v_mixup(44) xor (v_mixup(86) and not v_mixup(90)) xor v_mixup(79) xor v_mixup(87) xor v_mixin((i + 92) mod 96);
                    v_res(45) := v_mixup(45) xor (v_mixup(87) and not v_mixup(91)) xor v_mixup(80) xor v_mixup(88) xor v_mixin((i + 57) mod 96);
                    v_res(46) := v_mixup(46) xor (v_mixup(88) and not v_mixup(92)) xor v_mixup(81) xor v_mixup(89) xor v_mixin((i + 41) mod 96);
                    v_res(47) := v_mixup(47) xor (v_mixup(89) and not v_mixup(93)) xor v_mixup(82) xor v_mixup(90) xor v_mixin((i + 27) mod 96);
                ...
                for i in 0 to streams - 1 loop
                    ...
                    v_res( 0) := v_mixup( 0) xor (v_mixup(42) and not v_mixup(46)) xor v_mixup(35) xor v_mixup(43) xor v_mixin((i + 64) mod 96);
                    v_res( 1) := v_mixup( 1) xor (v_mixup(43) and not v_mixup(47)) xor v_mixup(36) xor v_mixup(44) xor v_mixin((i + 95) mod 96);
                    v_res( 2) := v_mixup( 2) xor (v_mixup(44) and not v_mixup(48)) xor v_mixup(37) xor v_mixup(45) xor v_mixin((i + 70) mod 96);
                    v_res( 3) := v_mixup( 3) xor (v_mixup(45) and not v_mixup(49)) xor v_mixup(38) xor v_mixup(46) xor v_mixin((i +  6) mod 96);
                    v_res( 4) := v_mixup( 4) xor (v_mixup(46) and not v_mixup(50)) xor v_mixup(39) xor v_mixup(47) xor v_mixin((i + 93) mod 96);
                    v_res( 5) := v_mixup( 5) xor (v_mixup(47) and not v_mixup(51)) xor v_mixup(40) xor v_mixup(48) xor v_mixin((i + 21) mod 96);
                    v_res( 6) := v_mixup( 6) xor (v_mixup(48) and not v_mixup(52)) xor v_mixup(41) xor v_mixup(49) xor v_mixin((i + 76) mod 96);
                    v_res( 7) := v_mixup( 7) xor (v_mixup(49) and not v_mixup(53)) xor v_mixup(42) xor v_mixup(50) xor v_mixin((i + 85) mod 96);
                    v_res( 8) := v_mixup( 8) xor (v_mixup(50) and not v_mixup(54)) xor v_mixup(43) xor v_mixup(51) xor v_mixin((i + 40) mod 96);
                    v_res( 9) := v_mixup( 9) xor (v_mixup(51) and not v_mixup(55)) xor v_mixup(44) xor v_mixup(52) xor v_mixin((i + 83) mod 96);
                    v_res(10) := v_mixup(10) xor (v_mixup(52) and not v_mixup(56)) xor v_mixup(45) xor v_mixup(53) xor v_mixin((i + 56) mod 96);
                    v_res(11) := v_mixup(11) xor (v_mixup(53) and not v_mixup(57)) xor v_mixup(46) xor v_mixup(54) xor v_mixin((i + 29) mod 96);
                    v_res(12) := v_mixup(12) xor (v_mixup(54) and not v_mixup(58)) xor v_mixup(47) xor v_mixup(55) xor v_mixin((i + 12) mod 96);
                    v_res(13) := v_mixup(13) xor (v_mixup(55) and not v_mixup(59)) xor v_mixup(48) xor v_mixup(56) xor v_mixin((i +  9) mod 96);
                    v_res(14) := v_mixup(14) xor (v_mixup(56) and not v_mixup(60)) xor v_mixup(49) xor v_mixup(57) xor v_mixin((i + 68) mod 96);
                    v_res(15) := v_mixup(15) xor (v_mixup(57) and not v_mixup(61)) xor v_mixup(50) xor v_mixup(58) xor v_mixin((i + 73) mod 96);
                    v_res(16) := v_mixup(16) xor (v_mixup(58) and not v_mixup(62)) xor v_mixup(51) xor v_mixup(59) xor v_mixin((i + 78) mod 96);
                    v_res(17) := v_mixup(17) xor (v_mixup(59) and not v_mixup(63)) xor v_mixup(52) xor v_mixup(60) xor v_mixin((i + 69) mod 96);
                    v_res(18) := v_mixup(18) xor (v_mixup(60) and not v_mixup(64)) xor v_mixup(53) xor v_mixup(61) xor v_mixin((i + 22) mod 96);
                    v_res(19) := v_mixup(19) xor (v_mixup(61) and not v_mixup(65)) xor v_mixup(54) xor v_mixup(62) xor v_mixin((i + 47) mod 96);
                    v_res(20) := v_mixup(20) xor (v_mixup(62) and not v_mixup(66)) xor v_mixup(55) xor v_mixup(63) xor v_mixin((i + 42) mod 96);
                    v_res(21) := v_mixup(21) xor (v_mixup(63) and not v_mixup(67)) xor v_mixup(56) xor v_mixup(64) xor v_mixin((i + 82) mod 96);
                    v_res(22) := v_mixup(22) xor (v_mixup(64) and not v_mixup(68)) xor v_mixup(57) xor v_mixup(65) xor v_mixin((i + 44) mod 96);
                    v_res(23) := v_mixup(23) xor (v_mixup(65) and not v_mixup(69)) xor v_mixup(58) xor v_mixup(66) xor v_mixin((i + 54) mod 96);
                    v_res(24) := v_mixup(24) xor (v_mixup(66) and not v_mixup(70)) xor v_mixup(59) xor v_mixup(67) xor v_mixin((i + 36) mod 96);
                    v_res(25) := v_mixup(25) xor (v_mixup(67) and not v_mixup(71)) xor v_mixup(60) xor v_mixup(68) xor v_mixin((i +  5) mod 96);
                    v_res(26) := v_mixup(26) xor (v_mixup(68) and not v_mixup(72)) xor v_mixup(61) xor v_mixup(69) xor v_mixin((i +  3) mod 96);
                    v_res(27) := v_mixup(27) xor (v_mixup(69) and not v_mixup(73)) xor v_mixup(62) xor v_mixup(70) xor v_mixin((i + 63) mod 96);
                    v_res(28) := v_mixup(28) xor (v_mixup(70) and not v_mixup(74)) xor v_mixup(63) xor v_mixup(71) xor v_mixin((i + 31) mod 96);
                    v_res(29) := v_mixup(29) xor (v_mixup(71) and not v_mixup(75)) xor v_mixup(64) xor v_mixup(72) xor v_mixin((i + 16) mod 96);
                    v_res(30) := v_mixup(30) xor (v_mixup(72) and not v_mixup(76)) xor v_mixup(65) xor v_mixup(73) xor v_mixin((i + 87) mod 96);
                    v_res(31) := v_mixup(31) xor (v_mixup(73) and not v_mixup(77)) xor v_mixup(66) xor v_mixup(74) xor v_mixin((i + 38) mod 96);
                    v_res(32) := v_mixup(32) xor (v_mixup(74) and not v_mixup(78)) xor v_mixup(67) xor v_mixup(75) xor v_mixin((i + 10) mod 96);
                    v_res(33) := v_mixup(33) xor (v_mixup(75) and not v_mixup(79)) xor v_mixup(68) xor v_mixup(76) xor v_mixin((i + 81) mod 96);
                    v_res(34) := v_mixup(34) xor (v_mixup(76) and not v_mixup(80)) xor v_mixup(69) xor v_mixup(77) xor v_mixin((i + 60) mod 96);
                    v_res(35) := v_mixup(35) xor (v_mixup(77) and not v_mixup(81)) xor v_mixup(70) xor v_mixup(78) xor v_mixin((i + 51) mod 96);
                    v_res(36) := v_mixup(36) xor (v_mixup(78) and not v_mixup(82)) xor v_mixup(71) xor v_mixup(79) xor v_mixin((i + 43) mod 96);
                    v_res(37) := v_mixup(37) xor (v_mixup(79) and not v_mixup(83)) xor v_mixup(72) xor v_mixup(80) xor v_mixin((i + 75) mod 96);
                    v_res(38) := v_mixup(38) xor (v_mixup(80) and not v_mixup(84)) xor v_mixup(73) xor v_mixup(81) xor v_mixin((i +  8) mod 96);
                    v_res(39) := v_mixup(39) xor (v_mixup(81) and not v_mixup(85)) xor v_mixup(74) xor v_mixup(82) xor v_mixin((i + 89) mod 96);
                    v_res(40) := v_mixup(40) xor (v_mixup(82) and not v_mixup(86)) xor v_mixup(75) xor v_mixup(83) xor v_mixin((i + 39) mod 96);
                    v_res(41) := v_mixup(41) xor (v_mixup(83) and not v_mixup(87)) xor v_mixup(76) xor v_mixup(84) xor v_mixin((i + 86) mod 96);
                    v_res(42) := v_mixup(42) xor (v_mixup(84) and not v_mixup(88)) xor v_mixup(77) xor v_mixup(85) xor v_mixin((i + 14) mod 96);
                    v_res(43) := v_mixup(43) xor (v_mixup(85) and not v_mixup(89)) xor v_mixup(78) xor v_mixup(86) xor v_mixin((i +  7) mod 96);
                    v_res(44) := v_mixup(44) xor (v_mixup(86) and not v_mixup(90)) xor v_mixup(79) xor v_mixup(87) xor v_mixin((i + 52) mod 96);
                    v_res(45) := v_mixup(45) xor (v_mixup(87) and not v_mixup(91)) xor v_mixup(80) xor v_mixup(88) xor v_mixin((i +  0) mod 96);
                    v_res(46) := v_mixup(46) xor (v_mixup(88) and not v_mixup(92)) xor v_mixup(81) xor v_mixup(89) xor v_mixin((i + 49) mod 96);
                    v_res(47) := v_mixup(47) xor (v_mixup(89) and not v_mixup(93)) xor v_mixup(82) xor v_mixup(90) xor v_mixin((i + 17) mod 96);
